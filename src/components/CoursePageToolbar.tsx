...
const CoursePageToolbar = ({
  ...
  const [showAdvancedOptions, setShowAdvancedOptions] = useState(false); // Start collapsed
  ...
  const handleRevisionToggle = () => {
    console.log("Toggling revision mode");
    onRevisionModeToggle();
  };
  ...
  return (
    <div className="bg-black text-white border-gray-800">
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6 p-4 bg-gray-900/50 rounded-lg border border-gray-700">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Button 
            ...
            variant="outline" 
            size="sm" 
            className="border-gray-600 text-xs bg-zinc-950 hover:bg-zinc-800 text-slate-50"
          >
            {allStepsCollapsed ? (
              <>
          ...
          <Button 
            ...
            variant="outline" 
            size="sm" 
            className="border-gray-600 text-gray-300 hover:text-white text-xs bg-zinc-950 hover:bg-zinc-800"
          >
            {allLecturesCollapsed ? (
              <>
                <ChevronDown className="w-3 h-3 mr-1" />
      ...
      {showAdvancedOptions && (
        <div className="mb-4 p-4 bg-gray-800/50 rounded-lg border border-gray-700 transition-all duration-300 ease-in-out">
