        ...
        <main className="flex-1 pt-20 p-3 sm:p-6 bg-black min-h-screen">
          <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-400">Ace your technical interviews with expert guidance and practice</p>
            </div>
            ...
            <Card className="bg-gray-900 border-gray-800">
              <CardContent className="p-6">
                <div className="relative">
                  ...
                  <Input
                    placeholder="Search interview prep courses..."
                    value={filterQuery}
                    ...
                    <CardContent>
                      ...
                      <div className="flex space-x-2">
                        ...
                        <Button 
                          ...
                          className={`${enrollment ? 'flex-1' : 'flex-1'} bg-purple-600 hover:bg-purple-700 text-white`}
                        >
