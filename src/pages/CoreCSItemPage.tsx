        ...
        <main className="flex-1 pt-24 p-3 sm:p-6 bg-black min-h-screen">
          <div className="max-w-7xl mx-auto space-y-6">
            ...
            <ProgressOverviewCard
              ...
              totalProblems={180}
              progressItems={[
                { label: "Easy", completed: 0, total: 54, color: "green" },
                { label: "Medium", completed: 0, total: 90, color: "yellow" },
                { label: "Hard", completed: 0, total: 36, color: "red" }
              ]}
            />
